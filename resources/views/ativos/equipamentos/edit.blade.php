        ...
        <div class="col-lg-10">
            ...
            <form action="{{ route('ativos.equipamentos.update', $equipamento->id) }}" method="POST" class="card shadow-sm border-0">
                ...
                <div class="card-body">
                    ...
                    <div class="row g-3">
                        <div class="col-md-12">
                            <textarea name="observacao" class="form-control shadow-none" rows="4" placeholder="Detalhes adicionais, histórico de compras, avarias prévias...">{{ old('observacao', $equipamento->observacao) }}</textarea>
                        </div>
                    </div>
                </div>
