...
@section('title', 'Tipos de Contatos / Cargos')

@section('content')
    <div class="container-fluid">
        <div class="card card-outline card-primary shadow-sm mb-4">
            <div class="card-header border-0 py-3 d-flex align-items-center flex-wrap">
                <h3 class="card-title fw-bold mb-0">Tipos de Contato / Cargo</h3>
                <div class="card-tools ms-auto d-flex gap-2">
                    <button type="button" class="btn btn-primary btn-sm rounded-pill px-3 shadow-sm" data-bs-toggle="modal"
                        ...
                        <i class="fa-solid fa-plus me-1"></i> Novo Tipo/Cargo
                    </button>
                </div>
            </div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end pe-4">
                                        ...
                                        <form id="delete-tipo-{{ $tipo->id }}"
                                            action="{{ route('tipos_clientes.destroy', $tipo) }}" method="POST"
                                            style="display: none;">
                                            @csrf
                                            @method('DELETE')
                                        </form>
                            ...
                            @empty
                                <tr>
                                    <td colspan="4" class="text-center text-muted py-5 mt-4 mb-4">
                                        <div class="mb-2"><i class="fa-solid fa-id-badge fa-3x opacity-25"></i></div>
                                        Nenhum tipo de contato/cargo encontrado.
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
            ...
            <div class="modal-content shadow">
                <form action="{{ route('tipos_clientes.store') }}" method="POST">
                    ...
                    <div class="modal-header bg-primary text-white">
                        <h5 class="modal-title"><i class="fa-solid fa-user-tag me-2"></i>Cadastrar Tipo/Cargo</h5>
                        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                    </div>
                    <div class="modal-body">
                        <div class="mb-3">
                            <label class="form-label fw-bold">Nome / Cargo</label>
                            <input type="text" name="nome" class="form-control" required placeholder="EX: DIRETOR">
                        </div>
                        <div class="mb-3">
            ...
            <div class="modal-content shadow">
                <form id="formEditarTipo" method="POST">
                    ...
                    <div class="modal-header bg-info text-white">
                        <h5 class="modal-title"><i class="fa-solid fa-pen-to-square me-2"></i>Editar Tipo/Cargo</h5>
                        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                    </div>
                    <div class="modal-body">
                        <div class="mb-3">
    ...
    @push('scripts')
        <script>
            function editTipo(tipo) {
                ...
                document.getElementById('formEditarTipo').action = `/tipos_clientes/${tipo.id}`;
            ...
            function confirmDeleteTipo(id) {
                Swal.fire({
                    title: 'Tem certeza?',
                    text: "Este cargo será excluído. (Não poderá ser excluído se houver contatos vinculados a ele)",
                    icon: 'warning',
