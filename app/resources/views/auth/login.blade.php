...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .btn-primary { width: 100%; background: linear-gradient(135deg, #2563eb, #1d4ed8); color: #ffffff; border: none; border-radius: 0.6rem; padding: 0.85rem; font-size: 0.95rem; font-weight: 600; cursor: pointer; display: flex; align-items: center; justify-content: center; gap: 0.35rem; box-shadow: 0 10px 15px -3px rgba(37, 99, 235, 0.3); transition: transform 0.12s, box-shadow 0.12s, filter 0.12s; margin-top: 0.5rem; }
